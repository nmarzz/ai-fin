...
class DRLAgent:
    ...
    def train_model(self, model, tb_log_name, total_timesteps=5000,eval_env = None,n_eval_episodes = 5):
        model = model.learn(total_timesteps=total_timesteps, tb_log_name=tb_log_name,eval_env = eval_env,n_eval_episodes = n_eval_episodes)
        return model
